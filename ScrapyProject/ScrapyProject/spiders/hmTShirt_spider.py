...
class HMTShirtSpider(scrapy.Spider):
    ...
    def parse(self, response):
        tShirts=[
            response.css('a[href*="/fr_fr/homme/catalogue-par-produit/t-shirts-et-debardeurs.html"]::attr(href)').get(),
            response.css('a[href*="/fr_fr/femme/catalogue-par-produit/tops.html"]::attr(href)').get(),
        ]
        for tShirt in tShirts:
            if '/homme/' in tShirt:
                yield response.follow(tShirt, callback=self.parse_tShirt, meta={'gender': 'men'})
            elif '/femme/' in tShirt:
                yield response.follow(tShirt, callback=self.parse_tShirt, meta={'gender': 'women'})
    ...
    def closed(self, reason):
        ...
        <body>
            ...
            <div class="container mt-5">
                <h3 class="text-center mt-4 mb-4">T-Shirt Statistics</h3>
